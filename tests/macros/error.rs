...
fn implementation() {
    ...
    assert_eq!(
        WithFields::new(4, "hello").description(),
        "[WithFields] Fields are 4 and hello."
    );
    assert_eq!(
        Nested::new(NestedCause::WithFields(WithFields::new(4, "hello")))
            .description(),
        "[Nested] Nested error."
    );
